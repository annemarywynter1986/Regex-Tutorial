# Matching an Email Regex: Understanding the Components by Anne Wynter
...
**Example:** Consider the following email address: `anmary_234-@gmail.com`

The local part, of the username, is `anmary_234-`.

Now let's break it down according to the bracket expression `[a-z0-9_\.-]`:
- `anmary` contains lowercase letters `a`, `n`, `m`, `r`, and `y`, matching the `a-z` part of the expression.
- `_` is an underscore character, matching the `_` part of the expression.
- `234` contains digits `2`, `3`, and `4`, matching the `0-9` part of the expression.
...
In the example, the bracket expression `[a-z0-9_\.-]` successfully matches the local part `anmary_234-` of the email address.
...
**Example:** Consider the following email address: `anmary@gmail2023.edu`

The domain part of the email address is `gmail2023.edu`.

Now let's break it down according to the bracket expression `[\da-z\.-]`
- `gmail` contains lowercase letters `g`, `m`, `a`, and `l`, matching the `a-z` part of the expression.
- `-` is a hyphen character, matching the `-` part of the expression.-
...
In this example, the bracket expression `[\da-z\.-]` successfully matches the domain part `gmail2023.com` of the email address.
...
**Example:** Consider the following email address: `anmary_1234.email@gmail123.examp.le`
...
1. `anmary.val@gmail.com` **(valid)**
2. `anmary@inval@bgmail.com` **(invalid)**
...
**Example:** Consider the following two email addresses:
1. `anmary-val@gmail.com` **(valid)**
2. `anmary--val@gmail.com` **(valid)**
3. `anmary@val_gmail.com` **(invalid)**
...
**Example:** Consider the following two email addresses:
1. `anmary.val2023@gmail.com` **(valid)**
2. `anmary123_val@gmail.com` **(valid)**
3. `aval@gmail7.com` **(valid)**
4. `anmary.val@2023gmail.com` **(invalid)**
